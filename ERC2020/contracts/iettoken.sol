...
contract IETToken{  //mycollege named token
   //------------------------------------------------------------------------------------------------ 
    string private constant MytokenName   =  "institute of Engineering & Technology, DAVV,";
    string constant private MytokenSymbol = "iet";
    uint8 constant private   decimal=  18;
    uint constant private _totalSupply=1000;
   //------------------------------------------------------------------------------------------------ 
...
//------------------------------------------------------------------------------------------------        
        ...
        function transfer(address _toreciever, uint256 _tokenvalue) public returns (bool success){
        // MUST trigger when tokens are transferred, including zero value transfers.
        ...
        if(_tokenvalue==0){emit zeroValue("zero is not transfferable ");}
...
//------------------------------------------------------------------------------------------------        
    ...
    function transferFrom(address _from, address _to, uint256 _valuetoken) public returns (bool){
